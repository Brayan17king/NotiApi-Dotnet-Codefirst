...
public class PermisosGenericosController : BaseController
{
    ...
    public async Task<ActionResult<PermisosGenericoDto>> Get(int Id)
    {
        ...
        return _mapper.Map<PermisosGenericoDto>(permisosGenericos);
    }

    [HttpPost]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<PermisosGenericoDto>> Post(PermisosGenericoDto permisosGenericosDto)
    {
        var permisosGenericos = _mapper.Map<PermisosGenerico>(permisosGenericosDto);
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<PermisosGenericoDto>> Put(int id, [FromBody] PermisosGenericoDto permisosGenericosDto)
    {
