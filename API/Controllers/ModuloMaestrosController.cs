...
public class ModuloMaestrosController : BaseController
{
    ...
    public async Task<ActionResult<ModuloMaestroDto>> Get(int id)
    {
        ...
        return _mapper.Map<ModuloMaestroDto>(moduloMaestros);
    }

    [HttpPost]
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<ModuloMaestroDto>> Post(ModuloMaestroDto moduloMaestrosDto)
    {
        var moduloMaestros = _mapper.Map<ModuloMaestro>(moduloMaestrosDto);
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ModuloMaestroDto>> Put(int id, [FromBody] ModuloMaestroDto moduloMaestrosDto)
    {
